...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($connection_info->connect_error) {
        die("Connection failed: " . $connection_info->connect_error);
    }
    ...
    if ($check_user_query->num_rows > 0) {
        // The user_id is valid, proceed with inserting the comment
        ...
        if ($insert_comment) {
            ...
            echo "Error adding comment: " . $connection_info->error;
        }
    } else {
        echo "Invalid user_id: $user_id";
    }
