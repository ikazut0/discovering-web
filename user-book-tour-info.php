...
$bookedToursQuery = "SELECT t.*, b.booking_date, i.tour_image FROM admin_tours t JOIN user_booking_info b ON t.tour_id = b.tour_id JOIN user_info u ON b.user_id = u.user_id JOIN admin_tour_images i ON t.tour_id = i.tour_id AND i.tour_thumb = 1 WHERE u.user_email = ?";
...
<div class="row justify-content-center">
    <div class="col-lg-9 col-md-12 px-4"> <?php
    while ($bookedTourData = mysqli_fetch_assoc($bookedToursResult)) {
        ...
        echo "<div class='mt-4'>";
        echo "<a href='ticket-user.php?tour_id={$bookedTourData['tour_id']}' class='btn btn-primary'>ОТРИМАТИ КВИТАНЦІЮ</a>"; echo "</div>"; echo "</div>"; echo "</div>"; echo "</div>";
        } ?>
        </div>
    </div>
</div>
