    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 mb-3 px-4">
                <h2 class="fw-bold">НАЗВА ТУРУ : <?php echo $tour_data['tour_name'] ?></h2>
            </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        if (mysqli_num_rows($img_q) > 0) {
                            ...
                            while ($img_res = mysqli_fetch_assoc($img_q)) {
                                echo "<div class='carousel-item $active_class'><img src='" . TOURS_IMG_PATH . $img_res['tour_image'] . "' class='d-block w-100 rounded' style='max-height: 370px;'></div>";
                                $active_class = '';
                            }
                        } else {
                            echo "<div class='carousel-item active'><img src='$tour_img' class='d-block w-100 rounded' style='max-height: 370px;'></div>";
                        }
                        ?>
                    </div>
            ...
            <div class="col-lg-5 col-md-12 px-4">
                <div class="card mb-4 border-0 shadow-sm rounded-3">
                    <div class="card-body">
                        ...
                        echo <<< price
                        <h4>ЦІНА ЗА ТУР : $tour_data[tour_price]₴</h4>
            ...
            <div class="col-12 mt-4 px-4">
                ...
                <div class="mt-5">
                    ...
                    <div id="comments">
                        ...
                        $comments_query = selectData("SELECT c.*, u.user_name FROM `tour_comments` c
                            LEFT JOIN `user_info` u ON c.user_id = u.user_id
                            WHERE c.`tour_id`=?", [$tour_data['tour_id']], 'i');

                        while ($comment_data = mysqli_fetch_assoc($comments_query)) {
                            echo "<p><strong>User:</strong> " . $comment_data['user_name'] . "</p>";
                            echo "<p><strong>Comment:</strong> " . nl2br($comment_data['comment_text']) . "</p>";
                            echo "<hr>";
                        }
                        ?>
                    </div>
                    ...
                    <?php if ($userLoggedIn): ?>
                        <form method="post" action="process_comment.php">
                            <div class="mb-3">
                                <label for="comment_text" class="form-label">Ваш коментар:</label>
