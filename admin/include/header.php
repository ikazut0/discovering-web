...
<div class="col-lg-2 bg-dark border-top border-3 border-secondary" id="dashboard-menu">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid flex-lg-column align-items-stretch">
            <h4 class="mt-2 text-light" style="font-size: 12px;">ПАНЕЛЬ УПРАВЛІННЯ САЙТОМ : </h4>
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="adminDropdown">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item"> <a class="nav-link text-light" href="tours.php" style="font-size: 12px;">📙 КАТАЛОГ ТУРІВ</a> </li>
                    
                    <li class="nav-item"> <a class="nav-link text-light" href="facilities.php" style="font-size: 12px;">🧩 КЛЮЧОВІ ОЗНАКИ ТУРІВ</a> </li>
                    
                    <li class="nav-item"> <a class="nav-link text-light" href="question.php" style="font-size: 12px;">👋🏻 СПИСОК ЗАПИТАНЬ</a> </li>
                    
                    <li class="nav-item"> <a class="nav-link text-light" href="settings.php" style="font-size: 12px;">⚙️ ОСНОВНІ НАЛАШТУВАННЯ</a> </li>
                </ul>
            </div>
        </div>
    </nav>
